...
import com.eu.grid.models.Employee;
 ...
 */
public class EhcacheAppGetAllManual {
...
//Create a Cache specifying its configuration.
        ...
        copyStrategyConfiguration.setClass("com.eu.grid.ManualReadWriteSerializationCopyStrategy");
        final CacheConfiguration cacheConfiguration = new CacheConfiguration("employee_cache", 10000000)
                .memoryStoreEvictionPolicy(MemoryStoreEvictionPolicy.LFU).copyOnRead(true).copyOnWrite(true).eternal(true);
